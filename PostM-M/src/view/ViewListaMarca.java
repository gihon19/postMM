...
public class ViewListaMarca extends JInternalFrame {
	...
	public ViewListaMarca(JDialog view){
		...
		super("Buscar Categorias",true,true,false,false);
		Init();
	...
	public ViewListaMarca(JFrame view){
		...
		super("Categoria",true,true,true,true);
		Init();
		
	}
	public ViewListaMarca(){
		super("Categorias",true,true,false,false);
		Init();
	}
	public void Init(){
		initComponents();
